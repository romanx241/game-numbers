...
import ru.netology.composition.data.GameRepositoryImpl
...
import ru.netology.composition.domain.usecases.GenerateQuestionUseCase
import ru.netology.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(
   ...
   private fun startGame() {
    ...
    private fun getGameSettings() {
        this.gameSettings = getGameSettingsUseCase()
